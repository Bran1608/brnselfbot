...
cl = PUY.LINE()
cl.login(token="EsVjrmoYMbrBgYZOXVSe.qgwnSbWXIJPc8paNRMCPJG.mT1fjN2BUKbI/4ij/TiFaJ7s41UeuJoVkJPYyjVGIOE=")
cl.loginResult()
...
helpmsg ="""┏━━━━━━━━━━━━┓
┣  【B̸͟͞R̸͟͞N̸͟͞ S̺͆E̺͆L̺͆F̺͆B̺͆O̺͆T̺͆】  ┫
┗━━━━━━━━━━━━┛
┏━━━♠️ᴄᴏᴍᴍᴀɴᴅ ʟɪsᴛ♠️━━━
┣➩ sᴄ (sᴇʟғ ᴄᴏᴍᴍᴀɴᴅ)
┣➩ ᴘᴄ (ᴘʀᴏᴛᴇᴄᴛ ᴄᴏᴍᴍᴀɴᴅ)
...
┣➩ ss (sᴇʟғ sᴇᴛᴛɪɴɢs)
┗━━━━━━━━━━━━━━━━━━
ᴛʜɪs ɪs ᴄʀᴇᴀᴛᴏʀ: http://line.me/ti/p/~ndut1608
♕ ᴵᶠ | ᔕ ꁅꀤꌃꋪꍏꈤ ᔕ ♕"""
...
Bots=[mid]
admin=["u40658db01c318a3a42f0f027ae67298e"]
        ...
        if op.type == 25:
            ...
            if msg.contentType == 13:
                ...
                if wait["lang"] == "JP":
                    ...
                    cl.sendText(msg.to,helpmsg)
            elif msg.text.lower() == 'sc':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,SC)
                else:
                    cl.sendText(msg.to,SC)
            elif msg.text.lower() == 'pc':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,PC)
                else:
                    cl.sendText(msg.to,PC)
            elif msg.text.lower() == 'gc':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,GC)
                else:
                    cl.sendText(msg.to,GC)
            elif msg.text.lower() == 'kc':
                if wait["lang"] == "JP":
                    cl.sendText(msg.to,KC)
                else:
                    cl.sendText(msg.to,KC)
            elif msg.text.lower() == 'ss':
                if wait["lang"] == "JP":
                ...
                start = time.time()
                cl.sendText(msg.to, "Tunggu Nyet")
...
# SETTINGS/PROTECT COMMAND
                ...
                if wait["protect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protect Menyala Bosque")
                    else:
                        cl.sendText(msg.to,"Protect Menyala Bosque")
                else:
                    wait["protect"] = True
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Protect Menyala Bosque")
            elif msg.text.lower() == 'Protectqr: On':
                if wait["linkprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"QR Di Protect")
                    else:
                        cl.sendText(msg.to,"QR Di Protect")
                else:
                ...
                if wait["inviteprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Invite Di Protect")
                    else:
                        cl.sendText(msg.to,"Invite Di Protect")
                else:
                ...
                if wait["cancelprotect"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Cancel Invite On")
                    else:
                        cl.sendText(msg.to,"Cancel Invite On")
                else:
                ...
                if wait["protect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Protect Off Bosque")
                    else:
                        cl.sendText(msg.to,"Protect Off Bosque")
                else:
                    wait["protect"] = False
                    if wait["lang"] == "JP":
                        ...
                        cl.sendText(msg.to,"Protect Off Bosque")
            elif msg.text.lower() == 'Protectqr: Off':
                ...
                if wait["inviteprotect"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Done Bosque")
                    else:
                        cl.sendText(msg.to,"Done Bosque")
                else:
                ...
                if wait["timeline"] == True:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Link Post On")
                    else:
                        cl.sendText(msg.to,"Link Post On")
                else:
                    wait["timeline"] = True
                ...
                if wait["timeline"] == False:
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Link Post Offf")
                    else:
                        cl.sendText(msg.to,"Link Post Off")
                else:
                    wait["timeline"] = False
                    if wait["lang"] == "JP":
                        cl.sendText(msg.to,"Link Post Off")
...
#End
                ...
                wait["invite"] = True
                cl.sendText(msg.to,"Kirim Kontak Yg Mau Di Invite")
...
#######
              ...
              if msg.toType == 2:
                ...
                cl.sendText(msg.to, rst)
                    ...
                    try:
                        cl.sendText(msg.to,"Sedang Di Restart...")
                        cl.sendText(msg.to,"Restart Selesai!")
                        restart_program()
                    except:
...
########
        ...
        if op.type == 17:
          ...
          print "Seseorang Masuk Grup"
        if op.type == 15:
          if op.param2 in Bots:
             return
          random.choice(KAC).sendText(op.param1, "Pergi Jauh Jauh Lu Bau.")
          print "Seseorang Keluar Grup"
#------------------------------------------------------------------------------#
        if op.type == 55:
            try:
